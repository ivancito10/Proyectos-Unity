...
public class AmmoSpawner : MonoBehaviour {
	...
	private Transform theTansform = null;
	...
	void Awake (){
		theTansform = GetComponent<Transform> ();
	}
	...
	public void FireAmmo(){
		GameObject ammo = Instantiate (ammoPrefab, theTansform.position, theTansform.rotation) as GameObject;
